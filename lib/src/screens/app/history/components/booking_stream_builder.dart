...
StreamBuilder<QuerySnapshot<Map<String, dynamic>>> bookingStreamBuilder(
    TextTheme style) {
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: snapshot
                                        .data.docs[index]['services'].length,
                                    itemBuilder:
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  width: 80.w,
                                  child: duTimeLineFormat((snapshot
                                                      .data.docs[index]
